...
stylesheets = do
    ...
    link_ [rel_ "stylesheet", type_ "text/css", href_ "https://cdn.jsdelivr.net/gh/chalkandcheese/epistyle/dist/base.min.css"]
...
sourceCode =
    a_
        [ href_ "https://github.com/chalkandcheese/astrochart.xyz"
